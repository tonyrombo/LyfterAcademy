...
class TestLogicManager(unittest.TestCase):
    ...
    def setUp(self): #SetUp is used for being executed before the tests
        ...
        self.test_file = "finance_data.json"
    ...
    def test_save_and_load_data_consistency(self):
        ...
        self.manager.save_data()
        # Act
        new_manager = LogicManager(filepath=self.test_file)
        # Assert
        self.assertEqual(new_manager.data, {"categories": ["Health"], "transactions": []})

    def test_add_category_adds_only_if_not_duplicate(self):
        # Act
        self.manager.add_category("Food")
        self.manager.add_category("Food")  # Try duplicates
        # Assert
    ...
    def test_add_transaction_appends_transaction(self):
        ...
        # Assert
        self.assertIn(transaction, self.manager.data["transactions"])
    ...
    def test_validate_transaction_returns_expected_errors(self):
        ...
        valid_result = LogicManager.validate_transaction(valid)
        ...
        invalid_result = LogicManager.validate_transaction(invalid)
